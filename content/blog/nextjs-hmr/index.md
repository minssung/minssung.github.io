...
개념적으로 보면 코드 업데이트를 위한 여러 기술들이 있는데, 이 중에서 <b>HMR(Hot Moudle Replacement)</b>이 가장 기본적인 메커니즘입니다. 이를 바탕으로, **Hot Reload**와 **Fast Refresh**는 **HMR**의 개념을 활용하거나 확장한 방식이라고 볼 수 있습니다.
