...
<div style="display: flex; gap: 20px; overflow-x: auto">
    <img src="./splash.png" alt="Image 1" style="width: 30%;">
    <img src="./login.png" alt="Image 2" style="width: 30%;">
    <img src="./main.png" alt="Image 3" style="width: 30%;">
    <img src="./main_written.PNG" alt="Image 4" style="width: 30%;">
</div>
...
![used PWA](./used_pwa.png)

<div id="caption">이미지를 ChatGPT로 생성했는데 로고와 서비스 매치가 이상하게 나왔네요...</div>
<!-- <figure align="center">
<figcaption style="color: gray;">이미지를 ChatGPT로 생성했는데 로고와 서비스 매치가 이상하게 나왔네요...</figcaption>
</figure> -->
...
![meeting minutes](./meeting_minutes.PNG)
...
![PWABuilder success](./pwabuilder_after.PNG)
...
![playstore detail](./playstore_detail.PNG)
